...
!function(exports, env, undefined) {
  ...
  //
  // Polyfill the Array#indexOf method for cross browser compatiblity.
  //
  ...
  //
  // Polyfill Array.isArray for cross browser compatiblity.
  //
            ...
            if (mappings && mappings.length > 0) {
              for (var ii = mappings.length - 1; ii >= 0; ii--) {
                ...
                tagbody = tagbody.replace(this.attr, function(str, key, value, a) {
                  ...
                  if (shouldSetAttribute && mapping.replace !== key) {
                    return str;
                    ...
                    if (typeof mapping.replacePartial2 !== 'undefined') {
                      ...
                      newdata = value.replace(mapping.replacePartial1, data[mapping.dataKey]);
                    }
                    ...
                    if (mapping.remove) {
                      ...
                      ( ({}).toString.call(mapping.value) === '[object RegExp]' &&
                        mapping.value.exec(value) !== null)
                    ) {
                      var v = data[mapping.dataKey];
  ...
  //
  // Provide helpfull aliases that well help with increased compatiblity as not
