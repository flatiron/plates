(function ( root, factory ) {
    ...
    function ( exports ) {
      ...
      Mapper.prototype = {
        replace: function mapperReplace ( val1, val2 ) {
          var l = last.call( this );
          l.replacePartial1 = val1;
          l.replacePartial2 = val2;
          return this;
        },
        use: function mapperUse ( val ) {
          last.call( this ).dataKey = val;
          return last.call( this ) && this;
        },
        to: function mapperTo ( val ) {
          return this.use( val );
        },
        where: function mapperwhere ( val ) {
          last.call( this, true ).attribute = val;
          return last.call( this ) && this;
        },
        "class": function mapperClass ( val ) {
          return this.where( 'class' ).is( val );
        },
        tag: function mapperTag ( val ) {
          last.call( this, true ).tag = val;
          return this;
        },
        is: function mapperIs ( val ) {
          last.call( this ).value = val;
          return last.call( this ) && this;
        },
        has: function mapperHas ( val ) {
          last.call( this ).value = val;
          this.replace( val );
          return last.call( this ) && this;
        },
        insert: function mapperInsert ( val ) {
          var l = last.call( this );
          l.replace = l.attribute;
          l.dataKey = val;
          return last.call( this ) && this;
        },
        as: function mapperAs ( val ) {
